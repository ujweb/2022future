const cloudKy = {
    '數位轉型': {
        ...
        'array': [
            {
                title: '數位轉型怎麼做？金融業、製造業、中小企業數位轉型案例',
                url: 'https://www.cw.com.tw/article/5114541',
                img: 'https://storage.googleapis.com/www-cw-com-tw/article/202104/article-608797f01d5e2.jpg',
            },
            {
                title: '燃油車、電動車都不能沒有盧明光：從零開始，我根本不怕',
                url: 'https://www.cw.com.tw/article/5118400',
                img: 'https://storage.googleapis.com/www-cw-com-tw/article/202110/purchase-reauisition-615a953aadae8.jpg',
            },
            {
                title: '美國頂級創投、零售龍頭全聯　為何肯砸億元給台灣新創界航海王？',
                url: 'https://www.cw.com.tw/article/5117763',
                img: 'https://storage.googleapis.com/www-cw-com-tw/article/202108/article-611cc15924912.jpg',
            }
        ]
    },
    '投資趨勢': {
    ...
    '電動車': {
        ...
        'array': [
            {
                title: '電動車躍進ETF熱門榜，股價卻低迷　該入手嗎？',
                url: 'https://www.cw.com.tw/article/5118436',
                img: 'https://storage.googleapis.com/www-cw-com-tw/article/202110/article-615d16b3d7b26.JPG',
            },
            {
                title: '台達電打敗一階供應商　「平鎮夜市」研發的祕密武器攻進未來車心臟',
                url: 'https://www.cw.com.tw/article/5118389',
                img: 'https://storage.googleapis.com/www-cw-com-tw/article/202110/purchase-reauisition-615a7344b5a07.jpg',
            },
            {
                title: '汽車大老最期待的人！電動車總司令劉揚偉　如何帶台廠賺全球生意？',
                url: 'https://www.cw.com.tw/article/5118379',
                img: 'https://storage.googleapis.com/www-cw-com-tw/article/202110/article-615aacdb00387.jpg',
            }
        ]
    },
    '元宇宙': {
    ...
    '加密貨幣': {
        ...
        'array': [
            ...
            },
            {
                ...
                url: 'https://www.cw.com.tw/article/5118369',
                img: 'https://storage.googleapis.com/www-cw-com-tw/article/202110/article-61572272c964b.JPG',
            }
        ]
    }
}
...
$('.message-button').on('click', function(e) {
    let kw = $(this).attr('data-kw');
    let cloudTemp = `<i class="message-close icon icon-cancel"></i>
    <div class="message-title mb-15 text-center">
        <h3 class="my-0">${cloudKy[kw].slogan}</h3>
    </div>
    <div class="message-body">
        <div class="row mx-0">
            <div class="col-md-4 px-md-20 px-0 my-15">
                <a href="${cloudKy[kw].array[0].url}" target="_blank" rel="noopener noreferrer" class="kw-item d-md-block d-flex">
                    <img class="d-block" src="${cloudKy[kw].array[0].img}" width="100%" alt="${cloudKy[kw].array[0].title}">
                    <span class="btn-black btn-text d-block h5 mt-md-15 my-0">${cloudKy[kw].array[0].title}</span>
                </a>
            </div>
            <div class="col-md-4 px-md-20 px-0 my-15">
                <a href="${cloudKy[kw].array[1].url}" target="_blank" rel="noopener noreferrer" class="kw-item d-md-block d-flex">
                    <img class="d-block" src="${cloudKy[kw].array[1].img}" width="100%" alt="${cloudKy[kw].array[1].title}">
                    <span class="btn-black btn-text d-block h5 mt-md-15 my-0">${cloudKy[kw].array[1].title}</span>
                </a>
            </div>
            <div class="col-md-4 px-md-20 px-0 my-15">
                <a href="${cloudKy[kw].array[2].url}" target="_blank" rel="noopener noreferrer" class="kw-item d-md-block d-flex">
                    <img class="d-block" src="${cloudKy[kw].array[2].img}" width="100%" alt="${cloudKy[kw].array[2].title}">
                    <span class="btn-black btn-text d-block h5 mt-md-15 my-0">${cloudKy[kw].array[2].title}</span>
                </a>
            </div>
        </div>
    </div>`;
